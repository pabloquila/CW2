...
<div class="content-wrapper">
  ...
  <div class="content">
      ...
      <form action="includes/create.officers.inc.php" method="POST">
          ...
          <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="station_address"  placeholder="Enter Station" Required>
                  </div>                  
              </div>
          </div>
          ...
          <div class="row">                                         
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                   <div class="form-group">
                      <label for="exampleInputEmail1">System ID</label>
                      <input type="text" class="form-control" name=" user_id"  placeholder="Enter ID from System" Required>
                  </div>                  
              </div>              
          </div>
