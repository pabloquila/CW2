...
<div class="content-wrapper">
  ...
  <div class="content">
      ...
      <form action="includes/create.offenses.inc.php" method="POST">

          <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label for="exampleInputEmail1"> Offense Code</label>
                    <input type="text" class="form-control" name="offense_code"  placeholder="Enter Offense ID" Required>
              </div>
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="offense_description"  placeholder="Enter Description" Required>
                  </div>                  
              </div>
          </div>
          ...
          <div class="row">                                         
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="offense_penalty_points"  placeholder="Enter Points" Required>
                  </div>                  
              </div>
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Fine</label>
                    <input type="text"  class="form-control" name="offense_fine_gbp"  placeholder="Enter Fine £" Required>
                  </div>                  
              </div>
          </div>
