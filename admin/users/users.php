    ...
    <div class="content">
        ...
        <div class="card-body">
          <table class="table table-bordered" id="data">
              <thead>
                  <tr>
                      <th scope="col" style="width: 10%; font-size: 15px;"> </th>
                      <th scope="col" style="width: 15%; font-size: 15px;"> User ID</th>
                      <th scope="col" style="width: 20%; font-size: 15px;" >Username</th>
                      <th scope="col" style="width: 20%; font-size: 15px;" >User Level</th>   
              ...
              <tbody>
                      ...
                      <tr>
                        <td></td>
                          ...
                          <td>
                              <a class="btn btn-warning btn-xs btn-flat" href="edit.users.php?id=<?php echo $data['user_id']; ?>">
                              <i class="fas fa-edit"></i></a>

                              <a class="btn btn-danger btn-xs btn-flat" href="delete.users.php?id=<?php echo $data['user_id']; ?>">
        ...
        <div class="card-footer">
          <a href="create.users.php" class="btn btn-primary btn-flat btnTest">
