...
<div class="content-wrapper">
    ...
    <div class="content">
          ...
          <table class="table table-bordered" id="data">
              <thead>
                  <tr>
                      ...
                      <th scope="col" style="width: 15%; font-size: 15px;"> Full Name</th>
                      <th scope="col" style="width: 20%; font-size: 15px;" >Station</th> 
                      <th scope="col" style="width: 20%; font-size: 15px;" >System ID</th>   
              ...
              <tbody>
                      <?php
                          ...
                          $records = mysqli_query($conn,"select * from officers");
                           while($data = mysqli_fetch_array($records))
                          {
                      ?>
                      <tr>
                          <td><?php echo $data['officer_id']; ?></td>
                          <td><?php echo $data['officer_fullname'];?></td>
                          <td><?php echo $data['station_address']; ?></td>
                          <td><?php echo $data['user_id']; ?></td>
                          <td>
                              <a class="btn btn-warning btn-xs btn-flat" href="edit.officers.php?id=<?php echo $data['officer_id']; ?>">
                              <i class="fas fa-edit"></i></a>

                              <a class="btn btn-danger btn-xs btn-flat" href="delete.officers.php?id=<?php echo $data['officer_id']; ?>">
        ...
        <div class="card-footer">
          <a href="create.officers.php" class="btn btn-primary btn-flat btnTest">
