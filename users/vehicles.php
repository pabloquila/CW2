    ...
    <div class="content">
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered" id="data">
                <thead>
                    <tr>
                        ...
                        <th scope="col" style="width: 10%; font-size: 15px;" >Owner</th>
                        <th scope="col" style="width: 18%; font-size: 15px;" >Licence Number</th>
                        <th scope="col" style="width: 17%; font-size: 15px;" >Chasis Number</th>
                        <th scope="col" style="width: 10%; font-size: 15px;" >Brand</th>                                    
                        <th scope="col" style="width: 10%; font-size: 15px;" >Colour </th>
                        <th scope="col" style="width: 15%; font-size: 15px;" >Insurance No</th>
                        <th scope="col" style="width: 5%; font-size: 15px;" >Options</th>                                           
                    </tr>
                    ...
                    <tbody>
                        <?php
                            ...
                            $records = mysqli_query($conn,"select * from vehicles");
                        ...
                        <tr>
                            ...
                            <td><?php echo $data['chasis_frame_number']; ?></td>
                            <td><?php echo $data['brand']; ?></td>
                            <td><?php echo $data['colour']; ?></td>
                            <td><?php echo $data['motor_insurance_number']; ?></td>
                            <td>
                                <a class="btn btn-warning btn-xs btn-flat" href="edit.vehicles.php?id=<?php echo $data['vehicle_id']; ?>">
                                <i class="fas fa-edit"></i></a>

                                <a class="btn btn-danger btn-xs btn-flat" href="delete.vehicles.php?id=<?php echo $data['vehicle_id']; ?>">
            ...
            <div class="card-footer">
                <a href="create.vehicles.php" class="btn btn-primary btn-flat btnTest">
